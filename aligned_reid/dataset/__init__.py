...
def create_dataset(
  ...
  print(name)
  if name == 'market1501':
    im_dir = ospj(data_dir, 'market1501/images')
    partition_file = ospj(data_dir, 'market1501/partitions.pkl')
    ...
    im_dir = ospj(data_dir, 'duke/images')
    partition_file = ospj(data_dir, 'duke/partitions.pkl')
